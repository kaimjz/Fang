...
(function ($)
{
    ...
    $.fn.wBox = function (options)
    {
        ...
        this.showBox = function ()
        {
            $("#wBox_overlay").remove();
            $("#wBox").remove();
            B = $("<div id='wBox_overlay' class='wBox_hide'></div>").addClass('wBox_overlayBG').css('opacity', _this.YQ.opacity).dblclick(function ()
            {
                _this.close();
            }).appendTo('body');
        ...
        */
        function handleClick()
        {
            ...
            {
                con.html("<div class='wBox_load'><div id='wBox_loading'><img src='/Theme/1/base/images/loading.gif' /></div></div>");
                if (_this.YQ.requestType === "img")
                {
                    ...
                    {
                        ifr = $("<iframe name='wBoxIframe' id='wBoxIframe' style='width:" + _this.YQ.iframeWH.width + "px;height:" + _this.YQ.iframeWH.height + "px;' scrolling='auto' frameborder='0' src='" + _this.YQ.target + "'></iframe>");
                        ...
                        ifr.load(function ()
                        {
                            try
                            {
                                ...
                                $it.find('.user_close').click(_this.close);
        ...
        */
        function setPosition()
        {
            ...
            //var width = ifr.width(), lt = calPosition(width);
            var width = $("#wBox").width(), lt = calPosition(width);
            C.css({
                left: lt[0],
                top: lt[1]
            });
