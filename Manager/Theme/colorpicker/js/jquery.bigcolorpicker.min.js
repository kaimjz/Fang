(function (a) {
    var f = new function () {
        ...
        this.init = function () {
            ...
            for (var f = 0, i = [], m = [], b = 0; b < d.length; b++) for (var j = o(d[b][0][0], d[b][0][1]), s = o(d[b][1][0], d[b][1][1]), a = 0; a < e; a++) b < 3 ? i[f] = o(j[a], s[a]) : m[f - e * 3] = o(j[a], s[a]), f++;
        ...
        this.showPicker = function (h, d, b) {
            ...
            a("#bigpicker").length <= 0 && a(document.body).append('<div id="bigpicker" class="bigpicker"><ul class="bigpicker-bgview-text" ><li><div id="bigBgshowDiv"></div></li><li style="display:none;"><input id="bigHexColorText" size="7" maxlength="7" value="#000000" /></li></ul><div id="bigSections" class="bigpicker-sections-color"></div><div id="bigLayout" class="biglayout" ></div></div>');
            a("#bigLayout").unbind("hover").unbind("click").hover(function () {
                ...
                q($("#bigBgshowDiv").css("background-color"));  //点击的时候修改小方块的颜色
                a("#bigpicker").hide();
            ...
            a(this).unbind("click").bind("click", function (b) {
                ...
                a("#bigpicker").css({ left: b.left + 38+5 + "px" });
                a("#bigpicker").css({ top: b.top - 78 + "px" });
            ...
            if (d == "L") a("#bigSections").unbind("mousemove").unbind("mouseout").unbind("click").removeClass("bigpicker-bgimage"), u();
                ...
                a("#bigSections").unbind("mousemove").unbind("mouseout").unbind("click").mousemove(function (b) {
                    ...
                    //q(d)   //鼠标指向时改变方块的颜色 的函数。。需要注销，在点击颜色时去改变方块颜色
                }).mouseout(function () {
                    a("#bigLayout").hide()
                })
            }
